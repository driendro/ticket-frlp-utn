    			...
    			<div class="col-10 my-3">
    				...
    				<div class="form-group col" id="formUpdateUser">
    					...
    					<div class="row">
    						...
    						<div class="col-md-3">
    							<select @change="esEstudiante" class="mb-2 form-select" name="claustro"
    								v-model="selectClaustro">
    						...
    						<div class="col-md-3">
    							<select class="mb-2 form-select" name="especialidad">
    								<option <?= ($usuario->especialidad == 'civil') ? 'selected' : ''; ?> value="Civil">
    									Civil</option>
    								<option
    									<?= ($usuario->especialidad == 'Electrica') ? 'selected' : ''; ?>value="Electrica">
    									Electrica</option>
    								<option
    									<?= ($usuario->especialidad == 'Industrial') ? 'selected' : ''; ?>value="Industrial">
    									Industrial</option>
    								<option
    									<?= ($usuario->especialidad == 'Mecanica') ? 'selected' : ''; ?>value="Mecanica">
    									Mecanica</option>
    								<option <?= ($usuario->especialidad == 'Quimica') ? 'selected' : ''; ?>value="Quimica">
    									Quimica</option>
    								<option
    									<?= ($usuario->especialidad == 'Sistemas') ? 'selected' : ''; ?>value="Sistmeas">
    									Sistemas</option>
