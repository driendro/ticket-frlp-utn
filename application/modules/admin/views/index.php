                ...
                <div class="col-sm-8">
                    ...
                    <form action="<?= base_url('admin/cargar_saldo'); ?>" method="post">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" readonly class="form-control-plaintext" id="idSaldoActual" value="<?= $usuario->saldo ?>">
                            </div>
                            ...
                            <div class="col-sm-10">
                                <input type="text" readonly name='dni' class="form-control-plaintext" value="<?= $usuario->documento ?>">
                            </div>
                            <label class="col-sm-2 col-form-label">Especialidad:</label>
                            <div class="col-sm-10">
                                <input type="text" readonly class="form-control-plaintext" value="<?= $usuario->especialidad ?>">
                            </div>
                        ...
                        <div>
                            ...
                            <a class="btn btn-primary" href="<?= base_url("admin/modificar_usuario/{$usuario->id}"); ?>" role="button">Modificar usuario</a>
                        </div>
                    </form>
                </div>
                <div class="col-sm-2"></div>
